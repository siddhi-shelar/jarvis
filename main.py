...
def main_process():
    ...
    while True:
        ...
        if "hello" in request:
            speak("Welcome Siddhi, How can i help you.")
            ...
            pwk.sendwhatmsg("+919021812149", "Hi, How are you", 2, 10, 30)
        ...
        #     speak("Email sent")
            ...
            s.starttls()
            s.login("siddhi.shelar2612@gmail.com", user_config.gmail_password)
            message = """
            This is the message.

            Thanks by SIDDHI SHELAR.

            """
            s.sendmail("siddhi.shelar2612@gmail.com", "siddhi01052002@gmail.com", message)
            s.quit()
            speak("Email sent")
        elif "generate image" in request or "show image" in request or "image of" in request:
         prompt = (
           request.lower()
           .replace("jarvis", "")
         ...
         if prompt:
          ...
          speak("Please describe the image you want me to generate.")
